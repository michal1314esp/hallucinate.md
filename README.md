...
3. Look for the green **Code** button near the top. Click it.  
   - You will see options like **Download ZIP**. Click **Download ZIP** to save the full project to your computer.  

4. Save the ZIP file somewhere easy to find, like your Desktop or Downloads folder.

5. Open the ZIP file using Windows Explorer (just double-click it).

6. Extract all the files to a new folder you create, for example, “hallucinate_md”.

7. Now you have all files ready to use on your computer.
...
2. Inside, look for the main file. This might be a `.md` (Markdown) file or a simple script file.
...
- Adding instructions to AI conversations  
- Marking information as verified or unverified  
...
Developers use it in their AI tools to improve reliability, but you can also try it with simple AI chatbots that allow formatted instructions.
...
- Visit the GitHub page again to see if there are updated instructions or fixes.  

---

## 💡 Tips for Non-Technical Users

- Do not worry if you see files you do not recognize. You only need to open instructions and files named `.md` to start.  
- Use a free Markdown viewer if you want nicer reading of instructions.  
- If commands seem hard, ask someone with more experience to help set up Python or other tools.  
- Remember, this tool is designed for use together with AI services—it guides AI behavior, but does not work alone.  
